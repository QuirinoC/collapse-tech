...
{
    private const string BundleId = "com.collapse.pixelboard";
    private const string MonthlyProductId = "pixelboard.pro.monthly";
    private const string AnnualProductId = "pixelboard.pro.annual";
    ...
    public void VerifyAcceptsTrustedStoreKitTransaction()
    {
        ...
        Assert.Equal(token, result.Transaction.AppAccountToken.Value);
